...
export const INTERVIEW_RESULT = [
    {
        ...
        additional_question_1:
            '답변 감사합니다. OSI 7계층 중 전송계층에 대해서 자세하게 설명해주세요 1 ',
        additional_question_2:
            '답변 감사합니다. OSI 7계층 중 전송계층에 대해서 자세하게 설명해주세요 2 ',
        additional_question_3:
            '답변 감사합니다. OSI 7계층 중 전송계층에 대해서 자세하게 설명해주세요 3',
    },
    {
        ...
        gpt_answer:
            '프로세스의 구조는 data, heap, stack, code 총 4가지로 구성됐습니다.',
        additional_question_1:
            '답변 감사합니다. OSI 7계층 중 전송계층에 대해서 자세하게 설명해주세요1',
        additional_question_2:
            '답변 감사합니다. OSI 7계층 중 전송계층에 대해서 자세하게 설명해주세요2',
        additional_question_3:
            '답변 감사합니다. OSI 7계층 중 전송계층에 대해서 자세하게 설명해주세요3',
    },
    {
    ...
    },
    {
        ...
        gpt_answer:
            '프로세스의 구조는 data, heap, stack, code 총 4가지로 구성됐습니다.',
        additional_question_1: 'additional_question11',
        additional_question_2: 'additional_question22',
        additional_question_3: 'additional_question33',
    },
    {
